...
description: ""
lead: "Making our lives easier with Compose for our application"
date: 2022-06-27T00:05:09+08:00
lastmod: 2022-06-27T00:05:09+08:00
draft: false
images: []
menu:
  docs:
...
2. Next, we'll define the volume mapping. When we ran the container with `docker run`, the named volume was created
   ...
   the default options are used. There are [many more options available](https://docs.docker.com/compose/compose-file/) though.
